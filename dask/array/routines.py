...
def apply_along_axis(func1d, axis, arr, *args, **kwargs):
    ...
    if (shape is None) or (dtype is None):
        ...
        #print(func1d(test_data, *args, **kwargs), test_result, args, kwargs)
        #print(test_data.shape, test_result.shape, args, kwargs)
        if shape is None:
...
def _unique_internal(ar, indices, counts, return_inverse=False):
    ...
    Given that Dask likes to have one array returned from functions like
